    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('municipios.update', ['municipio' => $municipio->muni_codi]) }}">
            ...
            <div class=" mb-3">
                ...
                <input type="text" class="form-control" id="codigo" aria-describedby="codigoHelp" neme="id" disabled>
                <div id="codigoHelp" class="form-text">Municipality Id</div>
            </div>
            <div class="mb-3">
                <label for="name" class="form-label">Municipality</label>
                <input type="text" class="form-control" id="name" name="name" placeholder="Municipio name"
